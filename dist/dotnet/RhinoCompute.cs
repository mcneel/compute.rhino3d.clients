...
namespace Rhino.Compute
{
    public static class ComputeServer
    {
        ...
        public static string Version => "7.15.0";
    ...
    public static class CurveCompute
    {
        ...
        {
            return ComputeServer.Post<Curve>(ApiAddress(), startPt, startDir, endPt, endDir, radius);
        }
        ...
        public static Curve[] CreateMatchCurve(Curve curve0, bool reverse0, BlendContinuity continuity, Curve curve1, bool reverse1, PreserveEnd preserve, bool average)
        {
            return ComputeServer.Post<Curve[]>(ApiAddress(), curve0, reverse0, continuity, curve1, reverse1, preserve, average);
        }
        ...
        /// <param name="average">Adjust both curves to match each other.</param>
        /// <returns>The results of the curve matching, if successful, otherwise an empty array.</returns>
        public static Curve[] CreateMatchCurve(Remote<Curve> curve0, bool reverse0, BlendContinuity continuity, Remote<Curve> curve1, bool reverse1, PreserveEnd preserve, bool average)
        {
            return ComputeServer.Post<Curve[]>(ApiAddress(), curve0, reverse0, continuity, curve1, reverse1, preserve, average);
        }
        ...
        /// </returns>
        public static bool CombineShortSegments(this Curve curve, out Curve updatedInstance, double tolerance)
        {
            return ComputeServer.Post<bool, Curve>(ApiAddress(), out updatedInstance, curve, tolerance);
        }
        ...
        /// True if short segments were combined or removed. False otherwise.
        /// </returns>
        public static bool CombineShortSegments(Remote<Curve> curve, out Curve updatedInstance, double tolerance)
        {
            return ComputeServer.Post<bool, Curve>(ApiAddress(), out updatedInstance, curve, tolerance);
        }
    ...
    public static class BrepCompute
    {
        ...
        public static bool IsBox(this Brep brep)
        {
        ...
        /// </summary>
        /// <returns>true if the Brep is a solid box, false otherwise.</returns>
        public static bool IsBox(Remote<Brep> brep)
        {
            return ComputeServer.Post<bool>(ApiAddress(), brep);
        }
        ...
        /// <returns>true if the Brep is a solid box, false otherwise.</returns>
        public static bool IsBox(this Brep brep, double tolerance)
        {
        ...
        /// <param name="tolerance">The tolerance used to determine if faces are planar and to compare face normals.</param>
        /// <returns>true if the Brep is a solid box, false otherwise.</returns>
        public static bool IsBox(Remote<Brep> brep, double tolerance)
        {
            return ComputeServer.Post<bool>(ApiAddress(), brep, tolerance);
        }
        ...
        {
            return ComputeServer.Post<Brep[], Brep[], Brep[]>(ApiAddress(), out outBlends, out outWalls, brep, distance, solid, extend, shrink, tolerance);
        }
        ...
        /// is true).
        /// </returns>
        public static Brep[] CreateOffsetBrep(Remote<Brep> brep, double distance, bool solid, bool extend, bool shrink, double tolerance, out Brep[] outBlends, out Brep[] outWalls)
        {
            return ComputeServer.Post<Brep[], Brep[], Brep[]>(ApiAddress(), out outBlends, out outWalls, brep, distance, solid, extend, shrink, tolerance);
        }
        ...
        /// </summary>
        public static Brep DestroyRegionTopology(this Brep brep)
        {
            return ComputeServer.Post<Brep>(ApiAddress(), brep);
        }

        /// <summary>
        /// Destroys a Brep's region topology information.
        /// </summary>
        public static Brep DestroyRegionTopology(Remote<Brep> brep)
        {
            return ComputeServer.Post<Brep>(ApiAddress(), brep);
        }
...
/// <returns>true on success, false on failure.</returns>
    ...
    public static class SubDCompute
    {
        ...
        {
            return ComputeServer.Post<SubD[]>(ApiAddress(), subdsToJoin, tolerance, joinedEdgesAreCreases);
        }
        ...
        {
            return ComputeServer.Post<SubD>(ApiAddress(), surface, method, corners);
        }
        ...
        /// </param>
        /// <returns></returns>
        public static SubD CreateFromSurface(Remote<Surface> surface, SubDFromSurfaceMethods method, bool corners)
        {
            return ComputeServer.Post<SubD>(ApiAddress(), surface, method, corners);
        }
        ...
        /// </param>
        /// <returns>true if faces were merged, false if no faces were merged.</returns>
        public static bool MergeAllCoplanarFaces(this SubD subd, out SubD updatedInstance, double tolerance)
        {
            return ComputeServer.Post<bool, SubD>(ApiAddress(), out updatedInstance, subd, tolerance);
        }
        ...
        /// </param>
        /// <returns>true if faces were merged, false if no faces were merged.</returns>
        public static bool MergeAllCoplanarFaces(this SubD subd, out SubD updatedInstance, double tolerance, double angleTolerance)
        {
            return ComputeServer.Post<bool, SubD>(ApiAddress(), out updatedInstance, subd, tolerance, angleTolerance);
        }
    ...
    public static class MeshCompute
    {
        ...
        {
            return ComputeServer.Post<Mesh>(ApiAddress(), cylinder, vertical, around, capBottom, capTop, circumscribe, quadCaps);
        }
        ...
        public static bool MatchEdges(this Mesh mesh, out Mesh updatedInstance, double distance, bool rachet)
        {
            return ComputeServer.Post<bool, Mesh>(ApiAddress(), out updatedInstance, mesh, distance, rachet);
        }
        ...
        /// </param>
        /// <returns>True of edges were matched, false otherwise.</returns>
        public static bool MatchEdges(Remote<Mesh> mesh, out Mesh updatedInstance, double distance, bool rachet)
        {
            return ComputeServer.Post<bool, Mesh>(ApiAddress(), out updatedInstance, mesh, distance, rachet);
        }
        ...
        /// </param>
        /// <returns>true if faces were merged, false if no faces were merged.</returns>
        public static bool MergeAllCoplanarFaces(this Mesh mesh, out Mesh updatedInstance, double tolerance)
        {
            return ComputeServer.Post<bool, Mesh>(ApiAddress(), out updatedInstance, mesh, tolerance);
        }
        ...
        /// </param>
        /// <returns>true if faces were merged, false if no faces were merged.</returns>
        public static bool MergeAllCoplanarFaces(Remote<Mesh> mesh, out Mesh updatedInstance, double tolerance)
        {
            return ComputeServer.Post<bool, Mesh>(ApiAddress(), out updatedInstance, mesh, tolerance);
        }
        ...
        /// </param>
        /// <returns>true if faces were merged, false if no faces were merged.</returns>
        public static bool MergeAllCoplanarFaces(this Mesh mesh, out Mesh updatedInstance, double tolerance, double angleTolerance)
        {
            return ComputeServer.Post<bool, Mesh>(ApiAddress(), out updatedInstance, mesh, tolerance, angleTolerance);
        }
        ...
        /// </param>
        /// <returns>true if faces were merged, false if no faces were merged.</returns>
        public static bool MergeAllCoplanarFaces(Remote<Mesh> mesh, out Mesh updatedInstance, double tolerance, double angleTolerance)
        {
            return ComputeServer.Post<bool, Mesh>(ApiAddress(), out updatedInstance, mesh, tolerance, angleTolerance);
        }
        ...
        /// <returns></returns>
        public static bool CreateVertexColorsFromBitmap(this Mesh mesh, out Mesh updatedInstance, RhinoDoc doc, TextureMapping mapping, Transform xform, System.Drawing.Bitmap bitmap)
        {
            return ComputeServer.Post<bool, Mesh>(ApiAddress(), out updatedInstance, mesh, doc, mapping, xform, bitmap);
        }
        ...
        /// <param name="bitmap">The bitmap to use for the colors.</param>
        /// <returns></returns>
        public static bool CreateVertexColorsFromBitmap(Remote<Mesh> mesh, out Mesh updatedInstance, RhinoDoc doc, TextureMapping mapping, Transform xform, System.Drawing.Bitmap bitmap)
        {
            return ComputeServer.Post<bool, Mesh>(ApiAddress(), out updatedInstance, mesh, doc, mapping, xform, bitmap);
        }
        ...
        {
            return ComputeServer.Post<Curve[]>(ApiAddress(), meshToContour, contourStart, contourEnd, interval, tolerance);
        }
        ...
        /// <code source='examples\py\ex_makerhinocontours.py' lang='py'/>
        /// </example>
        public static Curve[] CreateContourCurves(Remote<Mesh> meshToContour, Point3d contourStart, Point3d contourEnd, double interval, double tolerance)
        {
            return ComputeServer.Post<Curve[]>(ApiAddress(), meshToContour, contourStart, contourEnd, interval, tolerance);
        }
        ...
        {
            return ComputeServer.Post<Curve[]>(ApiAddress(), meshToContour, sectionPlane, tolerance);
        }
        ...
        /// <returns>An array of curves. This array can be empty.</returns>
        /// <seealso cref="Intersect.Intersection.MeshPlane(Mesh, Plane)"/>
        public static Curve[] CreateContourCurves(Remote<Mesh> meshToContour, Plane sectionPlane, double tolerance)
        {
            return ComputeServer.Post<Curve[]>(ApiAddress(), meshToContour, sectionPlane, tolerance);
        }
    }
    ...
    public static class AreaMassPropertiesCompute
    {
        ...
        {
            return ComputeServer.Post<AreaMassProperties>(ApiAddress(), brep, area, firstMoments, secondMoments, productMoments, relativeTolerance, absoluteTolerance);
        }
        ...
        /// <returns>The AreaMassProperties for the given Brep or null on failure.</returns>
        /// <exception cref="System.ArgumentNullException">When brep is null.</exception>
        public static AreaMassProperties Compute(Remote<Brep> brep, bool area, bool firstMoments, bool secondMoments, bool productMoments, double relativeTolerance, double absoluteTolerance)
        {
            return ComputeServer.Post<AreaMassProperties>(ApiAddress(), brep, area, firstMoments, secondMoments, productMoments, relativeTolerance, absoluteTolerance);
        }
    ...
    public static class VolumeMassPropertiesCompute
    {
        ...
        {
            return ComputeServer.Post<VolumeMassProperties>(ApiAddress(), brep, volume, firstMoments, secondMoments, productMoments, relativeTolerance, absoluteTolerance);
        }
        ...
        /// <returns>The VolumeMassProperties for the given Brep or null on failure.</returns>
        /// <exception cref="System.ArgumentNullException">When brep is null.</exception>
        public static VolumeMassProperties Compute(Remote<Brep> brep, bool volume, bool firstMoments, bool secondMoments, bool productMoments, double relativeTolerance, double absoluteTolerance)
        {
            return ComputeServer.Post<VolumeMassProperties>(ApiAddress(), brep, volume, firstMoments, secondMoments, productMoments, relativeTolerance, absoluteTolerance);
        }
    ...
    public static class IntersectionCompute
    {
        ...
        {
            return ComputeServer.Post<Point3d[]>(ApiAddress(), mesh, line);
        }
        ...
        /// <returns>An array of points: one for each face that was passed by the faceIds out reference.
        /// Empty if no items are found.</returns>
        public static Point3d[] MeshLine(Remote<Mesh> mesh, Line line)
        {
            return ComputeServer.Post<Point3d[]>(ApiAddress(), mesh, line);
        }
